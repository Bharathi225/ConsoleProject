...
public class StudentDatabase {
	...
	void toDisplaybyId(Connection connection) throws NullPointerException, SQLException {
		PreparedStatement prepstmnt = connection.prepareStatement("SELECT * FROM student_info WHERE id = ? ");  
	...
	void toUpdate(Connection connection) throws NullPointerException, SQLException{
		...
		PreparedStatement updateStmt = connection.prepareStatement("UPDATE student_info SET name = ? WHERE id = ?");
	...
	void toDelete(Connection connection) throws NullPointerException, SQLException{
		PreparedStatement pstmt = connection.prepareStatement("DELETE FROM student_info WHERE id = ? ");
